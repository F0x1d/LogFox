...
gradlePlugin {
    plugins {
        register("androidApplication") {
            ...
            implementationClass =
                "com.f0x1d.logfox.buildlogic.main.AndroidApplicationConventionPlugin"
        }
        ...
        register("androidFeature") {
            ...
            implementationClass =
                "com.f0x1d.logfox.buildlogic.main.feature.AndroidFeatureConventionPlugin"
        }
        register("androidFeatureCompose") {
            id = "logfox.android.feature.compose"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.main.feature.AndroidComposeFeatureConventionPlugin"
        }

        register("androidHilt") {
            id = "logfox.android.hilt"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.additional.AndroidHiltConventionPlugin"
        }
        register("androidCompose") {
            id = "logfox.android.compose"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.additional.AndroidComposeConventionPlugin"
        }
        register("androidParcelize") {
            id = "logfox.android.parcelize"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.additional.AndroidParcelizeConventionPlugin"
        }
        register("androidRoom") {
            id = "logfox.android.room"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.additional.AndroidRoomConventionPlugin"
        }
        register("androidTestsSnapshot") {
            id = "logfox.android.tests.snapshot"
            implementationClass =
                "com.f0x1d.logfox.buildlogic.additional.tests.AndroidSnapshotTestsConventionPlugin"
        }
    }
}
