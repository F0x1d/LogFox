...
internal sealed interface RecordingsCommand {
    ...
    data class Delete(val recordingId: Long) : RecordingsCommand
    ...
    // Navigation
    data class OpenRecordingDetails(val recordingId: Long) : RecordingsCommand
}
