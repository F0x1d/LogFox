...
internal class LogsSettingsRepositoryImpl @Inject constructor(
    ...
    override fun logsTextSize(): PreferenceStateFlow<Int> =
        localDataSource.logsTextSize().asPreferenceStateFlow()

    override fun logsDisplayLimit(): PreferenceStateFlow<Int> =
        localDataSource.logsDisplayLimit().asPreferenceStateFlow()

    override fun logsExpanded(): PreferenceStateFlow<Boolean> =
        localDataSource.logsExpanded().asPreferenceStateFlow()
    ...
    override fun showLogDate(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogDate().asPreferenceStateFlow()

    override fun showLogTime(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogTime().asPreferenceStateFlow()

    override fun showLogUid(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogUid().asPreferenceStateFlow()

    override fun showLogPid(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogPid().asPreferenceStateFlow()

    override fun showLogTid(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogTid().asPreferenceStateFlow()

    override fun showLogPackage(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogPackage().asPreferenceStateFlow()

    override fun showLogTag(): PreferenceStateFlow<Boolean> =
        localDataSource.showLogTag().asPreferenceStateFlow()
